          ...
          <tbody>
            {lines.length === 0 ? (
              ...
              lines.map((l) => {
                ...
                // Whole boxes + leftover loose pieces implied by a fractional
                // qty (e.g. 1.5 boxes of 40 = 1 box + 20 pieces) — qty itself
                // stays the single source of truth; this is just its display.
                ...
                return (
                  <tr key={l.lineId} className="border-b border-line">
                    <td className="whitespace-nowrap py-2 pr-1.5 print:border print:border-black print:px-2 print:py-1.5">
                      ...
                      {!l.discount && qtyHint && <div className="text-[10.5px] font-medium text-ink-faint">{qtyHint}</div>}
                    </td>
